...
public class DecoWindow extends JFrame  {
	...
	public DecoWindow() {
		...
		jp.add(new EnabledDecorator(new CoolDecorator(new JButton("Cool"))));

		jp.add(new EnabledDecorator(new SlashDecorator(new JButton("Slash"))));
		jp.add(new EnabledDecorator(new SlashDecorator(new CoolDecorator(new JButton("CoolSlash")))));
